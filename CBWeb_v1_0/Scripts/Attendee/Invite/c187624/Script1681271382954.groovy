...
WebUI.click(findTestObject('Inner session/Attendee/Invite/Invite_Email/Attendee_Invite_Email - delete'))

WebUI.click(findTestObject('Inner session/Attendee/Invite/Invite_Email/Attendee_Invite_Email - add Email'))

WebUI.setText(findTestObject('Inner session/Attendee/Invite/Invite_Email/Attendee_Invite_Email_Input mail'), 'yuki.lin.op3@gmail.com')

WebUI.click(findTestObject('Inner session/Attendee/Invite/Invite_Email/Attendee_Invite_Email_Invite btn'))

WebUI.verifyElementNotPresent(findTestObject('Inner session/Attendee/Invite/Invite_Email/Attendee_Invite_Email_non CB member - title'), 
    3000)
