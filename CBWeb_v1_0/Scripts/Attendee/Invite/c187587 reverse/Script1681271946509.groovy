...
WebUI.click(findTestObject('Inner session/Attendee/Invite/Invite member/Invite member edit'))

WebUI.click(findTestObject('Inner session/Attendee/Invite/Invite member/Invite member 1 delete'))

WebUI.click(findTestObject('Inner session/Attendee/Invite/Invite member/Invite member delete _ delete'))
...
WebUI.verifyElementNotPresent(findTestObject('Inner session/Attendee/Invite/Invite member/Invite member 1 email'), 3000)

WebUI.verifyElementNotPresent(findTestObject('Inner session/Attendee/Invite/Invite member/Invite member 2 email'), 3000)
