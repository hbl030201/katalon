...
WebUI.setText(findTestObject('Session List/sessionlist_search input'), 'Editor')
...
WebUI.waitForElementPresent(findTestObject('Inner session/Attendee/setting/Attendees_setting_Allow Editor invite Switch'), 
    3000)

'Owner點擊一次switch,給予Editor可邀人權限'
WebUI.click(findTestObject('Inner session/Attendee/setting/Attendees_setting_Allow Editor invite Switch'))
