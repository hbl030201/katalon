...
WebUI.verifyElementText(findTestObject('Accounts/Account settings Cloud integration/Unpair D and G text'), 'Unpairing Google Classroom also unpairs Google Drive . Unpair?')
