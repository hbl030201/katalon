...
'將 "new name" 改成 "rename"'
WebUI.setText(findTestObject('Object Repository/Session List/sessionlist_session_settings_Rename_name input'), 'rename')

WebUI.click(findTestObject('Object Repository/Session List/sessionlist_session_settings_Rename_name input_Save btn'))

WebUI.waitForElementNotPresent(findTestObject('Session List/sessionlist_first session name(only one session)'), 3000)
