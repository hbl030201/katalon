...
'確認是否有 Settings 欄位'
WebUI.verifyElementText(findTestObject('Sign in and out/Account_Account settings text'), 'Settings')

'確認是否有 Log out 欄位'
WebUI.verifyElementText(findTestObject('Sign in and out/Account_Log out text'), 'Log out')

'確認是否有 email 欄位'
WebUI.verifyElementText(findTestObject('Accounts/Account setting email'), 'creativeboard.at@gmail.com')

'確認是否有 name 欄位'
WebUI.verifyElementText(findTestObject('Accounts/Account setting name'), 'AT')
